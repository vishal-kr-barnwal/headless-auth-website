...
export const SITE = {
  website: "https://veda-verify.vercel.app/", // replace this with your deployed domain
  author: "Vishal Kumar",
  desc: "Veda Verify is end to end self hosted, headless authentication provider.",
  title: "VedaVerify",
  ogImage: "og-image.jpg",
  repo: "https://github.com/vishal-kr-barnwal/veda-verify-website",
};
...
export const Socials: SocialObjects = [
  {
    name: "Mail",
    href: "mailto:connect@vishalbarnwal.in",
  ...
  {
    name: "Github",
    href: "https://github.com/vishal-kr-barnwal",
    linkTitle: ` ${SITE.title} on Github`,
    active: true,
  },
  {
    name: "Instagram",
    href: "https://www.instagram.com/_vishal_barnwal/",
    linkTitle: `${SITE.title} on Instagram`,
    active: false,
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/vishal-barnwal/",
    linkTitle: `${SITE.title} on LinkedIn`,
    active: true,
  },
  {
    name: "Twitter",
    href: "https://x.com/_vishal_barnwal",
